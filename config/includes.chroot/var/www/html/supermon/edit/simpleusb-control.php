...
function Disp_Device_Form_Radio(
    $current,
    $title,
    $form_name,
    $opts,
...
switch (count($j['devices'])) {
    case 1:
        ?>
      <input type="text" name="device" value="<?php
      echo $device_cur; ?>" style="display:none">
        <?php
        break;
    case 2:
        Disp_Device_Form_Radio($device_cur, "<p style=\"font-size:1.1em;\">Select Device - &nbsp;&nbsp;  ", "device",
            "2", $keys[0], $keys[0], $keys[1], $keys[1]);
        break;
    case 3:
        Disp_Device_Form_Radio($device_cur, "<p style=\"font-size:1.1em;\">Select Device - &nbsp;&nbsp;   ", "device",
