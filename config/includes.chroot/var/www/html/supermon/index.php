...
<p>
  Welcome to <b><i><?php
            echo $CALL; ?></i></b> and associated AllStar nodes. This Bridge runs on the lastest HamVoIP Distribution of
  AllStar Link.
  <br><br>
...
<ul>
  <li>
    The <b>Direction</b> column shows <b>IN</b> when another node connected to us and <b>OUT</b> if the connection was
    made from us.
  </li>
  <li>
    The <b>Mode</b> column will show <b>Transceive</b> when this node will transmit and receive to/from the connected
    node. It will show <b>Receive Only</b> or <b>Local Monitor</b> if this node only receives from the connected node.
  </li>
</ul>
</p>
<p>
